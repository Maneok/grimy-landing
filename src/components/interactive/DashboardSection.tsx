...
export default function DashboardSection() {
  const baseClients = useMemo(() => [
    { name: 'CARRELAGES MOREAU SAS', siren: '821 456 789', score: 32, level: 'simplifiee', vig: 'Simplifiée', status: 'À jour', updated: 'il y a 3j', flag: false },
    { name: 'Hôtel Belle-Vue', siren: '503 219 884', score: 58, level: 'standard', vig: 'Standard', status: 'À revoir', updated: 'il y a 8j', flag: true },
    { name: 'BERNARD CONSULTING', siren: '892 145 008', score: 24, level: 'simplifiee', vig: 'Simplifiée', status: 'À jour', updated: 'il y a 1j', flag: false },
    ...
    { name: 'Pharmacie de la Place', siren: '772 561 408', score: 19, level: 'simplifiee', vig: 'Simplifiée', status: 'À jour', updated: 'il y a 5j', flag: false },
  ], []);
